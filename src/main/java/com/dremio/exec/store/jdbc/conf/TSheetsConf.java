...
@SourceType(value = "TSheetsARP", label = "TSheets",uiConfig = "tsheets-layout.json")
public class TSheetsConf extends AbstractArpConf<TSheetsConf> {
  private static final String ARP_FILENAME = "arp/implementation/tsheets-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.tsheets.TSheetsDriver";
